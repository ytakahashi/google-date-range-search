...
- Searches in a preset date range
  ...
  - You can create custom preset buttons for frequently used date ranges
- Searches in a custom date range
  - past _n_ hour(s)/day(s)/week(s)/month(s)/year(s)
- Searches in any date range
  - select any start and end date using a calendar interface

### Create custom preset buttons
...
<p align="center">
  <img src="./image/custom_preset1.png" alt="custom preset1" width="130"/>
  <img src="./image/custom_preset2.png" alt="custom preset2" width="130"/>
</p>
